...
$string['conexiones']          = 'Live / deferred connections';
$string['conexiones_desc']     = 'Time in live Zoom sessions and deferred Vimeo views (UDIMA API).';
...
$string['conexionesdelayed']   = 'Deferred (Vimeo)';
$string['conexionesdelayed_desc'] = 'Views of session recordings';
$string['conexioneserror']     = 'Could not load connection data';
$string['conexioneslive']      = 'Live (Zoom)';
...
$string['dedication_desc']     = 'Time connected to the course (Dedication block)';
...
$string['studentshowconexiones'] = 'Live / deferred connections';
$string['studentshowconexiones_desc'] = 'Show the student\'s Zoom live time and Vimeo deferred views.';
...
$string['studentshowdedication_desc'] = 'Show time spent in the course (requires the Dedication block).';
