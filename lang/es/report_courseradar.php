...
$string['conexionesallupdated'] = 'Todos los alumnos actualizados: {$a}';
...
$string['conexionescoldate']   = 'Fecha';
$string['conexionescolduration'] = 'Duración';
...
$string['conexionesexporting'] = 'Actualizando todos los alumnos y descargando…';
$string['conexioneslive']      = 'Sesiones en directo';
$string['conexioneslive_desc'] = 'Tiempo conectado a las sesiones en directo';
$string['conexionesnodetail']  = 'Sin detalle de sesiones';
$string['conexionesnone']      = 'Sin datos de conexión';
$string['conexionesprogress']  = 'Actualizando {$a->done} / {$a->total} alumnos';
...
$string['conexionesstale']     = 'Actualizado {$a}';
$string['conexionesunavailable'] = 'La API de conexiones no está configurada';
$string['conexionesupdated']   = 'Actualizado {$a}';
$string['conexionesupdating']  = 'Actualizando…';
...
$string['dedication_desc']     = 'Tiempo conectado al curso';
...
$string['studentshowconexiones_desc'] = 'Mostrar el tiempo en sesiones en directo y en diferido.';
...
$string['studentshowdedication_desc'] = 'Mostrar el tiempo de conexión al curso.';
...
$string['taskrefreshconexiones'] = 'Actualizar totales de conexiones Zoom/Vimeo';
$string['times']               = 'vistas';
